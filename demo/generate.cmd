...
set LOCATION=F:/database/antlr-4.7.1-complete.jar
java -jar %LOCATION% -Dlanguage=Cpp -listener -visitor -o generated/ -package WithDbSql NaiveSqlLexer.g4 NaiveSqlParser.g4 
